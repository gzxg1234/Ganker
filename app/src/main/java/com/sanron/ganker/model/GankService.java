...
import com.sanron.ganker.model.entity.HistoryDates;
import com.sanron.ganker.model.entity.SearchData;
...
public interface GankService {
    ...
    Observable<GankData> randomGank(@Path("category") String category,
                                    @Path("count") int count);
}
